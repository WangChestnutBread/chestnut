...
import SentenceButton from "../organisms/Navbar/SentenceButton";
import BookMarkButton from "../molecules/Navbar/BookMarkButton";
    ...
    <div className="NavbarExample">
      <div className="NavbarButton">
        ...
        <div className="RightButton">
          ...
          {/*챕터 3,4 페이지에서만 사용 */}
          {showBookMarkButton && (
            <BookMarkButton studyId={studyId} isVocabulary={isVocabulary} />
          )}
        </div>
      </div>
    </div>
