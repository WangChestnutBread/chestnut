    ...
    return(
        <div className="Page">
            ...
            <div style={{width: 786, height: 630, left: 327, top: 232, position: 'absolute', background: '#DCB78F', borderRadius: 25, overflow: 'hidden'}}>
                ...
                <div style={{padding: 10, left: 96, top: 403, position: 'absolute', background: '#DCB78F', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'inline-flex'}}>
                    <div style={{width: 29, height: 30, position: 'relative', background: 'white', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)', borderRadius: 10, border: '2px black solid'}} />
