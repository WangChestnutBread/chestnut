...
import InspectionForm from "../molecules/InspectionForm";
import MemberLogo from "../molecules/MemberLogo";
import SignUpPwInput from "../molecules/SignUpPwInput";
import InspectionFormNoRed from "../molecules/InspectionForm.noVerRed";
            ...
            <div className="Page">
                ...
                <div style={{width: 786, paddingTop: 42, paddingBottom: 22, paddingLeft: 104, paddingRight: 103, left: 327, top: 229, position: 'absolute', background: '#DCB78F', borderRadius: 25, overflow: 'hidden', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                    <div style={{flex: '1 1 0', alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 16, display: 'inline-flex'}}>
                        <div style={{alignSelf: 'stretch', height: 74, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 8, display: 'flex'}}>
                        ...
                        <div style={{alignSelf: 'stretch', height: 49, background: 'white', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)', borderRadius: 5, overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'inline-flex'}}>
                        ...
                        <div style={{alignSelf: 'stretch', height: 79, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 7, display: 'flex'}}>
