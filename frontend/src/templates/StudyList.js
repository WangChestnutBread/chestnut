    ...
    return(
        <div style={{width: '100%', height: '100%', paddingBottom: 80, background: '#FFF9F1', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
            <div style={{flex: '1 1 0', alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                <div style={{width: 1440, height: 80, position: 'relative', background: '#DCB78F', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
                    <NavBar />
                </div>
                <div style={{width: 1194, height: 864, position: 'relative', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
                    <div className="imgBox">
                        <img className="img" src="/image/squeez.png" />
                    </div>
                    <div style={{justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                        <div className="titleFont">무엇을 학습할까??</div>
                    </div>
                    <div style={{height: 645, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 79, display: 'inline-flex'}}>
                        ...
                        <div style={{height: 283, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'flex'}}>
                            <div style={{position: 'relative'}}>
                                <div style={{width: 276, height: 282, left: 306, top: 1, position: 'absolute', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                                    <div style={{width: 276, height: 282, position: 'relative'}}>
                                        <div style={{width: 276, height: 282, left: 0, top: 0, position: 'absolute'}}>
                                            <div style={{width: 276, height: 282, left: 0, top: 0, position: 'absolute', background: '#DCB78F', borderRadius: 25}} />
                                ...
                                <div style={{width: 276, height: 283, left: 0, top: 0, position: 'absolute', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                                    <div style={{width: 276, height: 283, position: 'relative'}}>
                                        <div style={{width: 276, height: 282, left: 0, top: 0, position: 'absolute'}}>
                                            <div style={{width: 276, height: 282, left: 0, top: 0, position: 'absolute', background: '#DCB78F', borderRadius: 25}} />
                                            <div style={{width: 260, left: 8, top: 19, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 24, fontFamily: 'Jua', fontWeight: '400', lineHeight: 22, wordWrap: 'break-word'}}>CH5. 단어</div>
                                        </div>
                                        <div style={{width: 276, height: 226, left: 0, top: 57, position: 'absolute', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                                            <img style={{width: 276, height: 226, borderTopLeftRadius: 25, borderTopRightRadius: 25}} src="https://via.placeholder.com/276x226" />
                                        </div>
                                        <div style={{width: 257, height: 44, left: 9, top: 228, position: 'absolute'}}>
                                            <div style={{width: 257, height: 44, left: 0, top: 0, position: 'absolute', background: '#6B3906', borderRadius: 10}} />
                                            <div style={{width: 125, height: 32, left: 60, top: 6, position: 'absolute', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                                                <div style={{flex: '1 1 0', alignSelf: 'stretch', position: 'relative'}}>
                                                    <div style={{left: 45, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Jua', fontWeight: '400', lineHeight: 22, wordWrap: 'break-word'}}>학습하기</div>
                                                    <div style={{width: 32, height: 32, left: 0, top: 0, position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'inline-flex'}}>
                                                        <div style={{width: 14.67, height: 18.67, background: 'white'}}></div>
                                ...
                                <div style={{width: 277, height: 282, left: 612, top: 0, position: 'absolute', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
