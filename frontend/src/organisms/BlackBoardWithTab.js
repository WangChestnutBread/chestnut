      ...
      <div className="BlackBoardWithLine">
        <div className="BlackBoardBody">
          ...
          <div className="TabButton">
            { content.map((item, i) => {
              return <BlackBoardTab key={`${item.categoryContent}-${i}`} tabTitle={item.categoryContent} isActive={currentTab === i} onClick={()=>{handleTabClick(i)}}/>;
            })}
          </div>
          ...
          <div className="BoardInside">
              ...
              <div className="LeftBoardList">
                {
                  content[currentTab].phonology.map((item, i)=>{
                    return (
                      <div>
                        <div className={`LeftBoardText ${ currentRule === i ? 'active': ''}`} onClick={()=>{setCurrentRule(i)}}>
            ...
            <div className="RightBoard">
              <p className="RightBoardText">{content[currentTab].phonology[currentRule].phonologyExplanation}</p>
            </div>
          </div>
